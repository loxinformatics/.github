    ...
    >
      <div className="flex flex-wrap mx-4">
        {descriptions.map((item: any, index: number) => {
          ...
          const itemImage = item.image || "/images/list_item.png";
            ...
            default:
              return (
                ...
                >
                  <Link
                    href=""
                    className={`group ${style.V1_services}
                  ...
                  >
                    ...
                    <div>
                      <h4
                        className={`${style.heading} text-color dark:text-color-reverse ${textColorGroupHover} transition-colors ease-in-out duration-300`}
                      >
                        {itemTitle}
                      </h4>
            ...
            case "V2":
              return (
                ...
                >
                  <Link
                    href=""
                    className={`group ${style.V2_services} flex pt-[40px]
                  ...
                  >
                    ...
                    <div>
                      <h4
                        className={`${style.heading} text-color dark:text-color-reverse ${textColorGroupHover} transition-colors ease-in-out duration-300 my-[15px]`}
                      >
                        {itemTitle}
                      </h4>
                      <p className={style.description}>{itemDescription}</p>
                    </div>
                  </Link>
                </div>
              );
