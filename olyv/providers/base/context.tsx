...
import { baseApiURL, handleHashLinkClick, homeURL } from "./config";
import type { BaseContextValues, BaseProps, ThemeColorKey } from "./types";
import Alert from "./widgets/Alert";
import Btn from "./widgets/Btn";
import { Form, FormStatus } from "./widgets/Form";
...
const baseContext = createContext<BaseContextValues | undefined>(undefined);
