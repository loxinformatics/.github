  ...
  return (
    render && (
      <Section
        ...
        padding={false}
        className={`
          ${coreStyles[`${sectionVersion}_cta`]}
          ${
            sectionVersion === "V1" &&
      ...
      >
        ...
        {sectionVersion === "V2" && (
          <div
            className={`${coreStyles.cta_container} p-20 bg-body-secondary dark:bg-body-secondary-reverse rounded-lg`}
          >
            <div className="flex flex-col md:flex-row gap-12">
              ...
              <div className="md:basis-1/2 lg:basis-2/3 order-first md:order-last flex items-center">
                <div
                  className={`${coreStyles.img} before:bg-body/50 dark:before:bg-body-reverse/50 after:bg-body/90 dark:after:bg-body-reverse/90`}
                >
                  {ctaImage && (
                    <Image
                      src={ctaImage}
