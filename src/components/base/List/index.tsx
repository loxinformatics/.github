...
import { useBase } from "../management/context";
            ...
            case "V2":
              return (
                ...
                >
                  <Anchor
                    href="#"
                    className={`group relative ${baseStyles.V2} flex pt-[40px]
                  ...
                  >
                    <div
                      className={`${bgPrimaryBefore30} ${baseStyles.icon} before:z-10`}
                    >
                      <i
            ...
            case "V3":
              return (
                <div
                  ...
                  data-aos-delay={`${50 + index * 50}`}
                >
                  <Anchor href="#" className={`group ${baseStyles.V3}`}>
                    <div className={baseStyles.img}>
                      <Image
                        src={itemImage}
                        className="w-full"
                        alt=""
                    ...
                    <div
                      className={`${baseStyles.details} relative
                      bg-body/90 dark:bg-body-reverse/90
                      shadow-lg dark:shadow-reverse
                      `}
                    >
                      <div
                        className={`${baseStyles.icon} text-white
                      ...
                      <Heading
                        variant="h5"
                        className={`${baseStyles.heading} ${textColorGroupHover}`}
                      >
                        {itemTitle}
                      </Heading>
                      <p className={baseStyles.description}>
