...
import type { FormResponse } from "../../../base/widgets/forms/Form/types";
import type {
  AuthReponse,
  DecodedToken,
  TokenResponse,
...
export default async function fetchAuth(): Promise<AuthReponse> {
...
export async function login({
  ...
  const setCookies = async (accessToken: string, refreshToken: string) => {
    ...
    const isSecure = process.env.DEBUG === "false";
